...
<div class="rows">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand"> Student ID Number:</a>
  </div>
		  ...
		  <form class="form-horizontal span4" action="#.php" method="POST">
					...
					<div class="panel panel-primary">
					  <div class="panel-heading">
					    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Advising of Subjects by Intake Teacher</h3>
					  </div>
				           ...
				           <table align="center">
						     ...
						     <tbody>
						     	<tr>
						     		...
						     		<td><?php echo (isset($cur)) ? $cur->FNAME.' '.$cur->MNAME : 'Fullname' ;?></td>
            ...
            <div class="col-10 col-sm-10 col-lg-10">
				  ...
				  <thead>
				  	<tr id="table">
				 		...
				 		<th width="15%" class="bottom">Pre-requisite</th>
				 		<th width="15%" align="center" class="bottom">Unit</th>
				  	...
				  	<?php
				  	 $cid = (isset($studcourse)) ? $studcourse->COURSE_ID : 0;
					  		$mydb->setQuery("SELECT * 
											...
											AND s.`COURSE_ID` =".$cid . " AND SEMESTER='Winter'");
				  ...
				  <tfoot>
					...
					$mydb->setQuery("SELECT SUM(UNIT) as UN
				  	...
				  	<tr><td  colspan="6" align="Right"><Strong>Total: </Strong></td>
				  		<td align="center" ><strong><?php echo $result->UN;?></strong></td>
				  	</tr>
					<tr><td  colspan="7"></td></tr>
				  	<tr><td colspan="2">Date Printed: <? print(Date("l F d, Y")); ?> .</td>
				  		<td colspan="2">Advised and signed by:</td><td ></td></tr> -->

				  	<tr><td class="bottom"  colspan="7"></td></tr>
				  	<tr><td colspan="6" align="Right"><Strong>Total: </Strong></td>
				  		<td align="center"><strong><?php echo $result->UN;?></strong></td></tr>
				  	<tr><td  colspan="2">Date Printed: <? print(Date("1 F d, Y"));?></td><!-- <Strong>Total: </Strong></td><td align="center" ><strong><?php echo $result->UN;?></strong></td>
				  	</tr>
				  	<tr><td  colspan="7"></td></tr> -->
				  	<td colspan="2">Advised and signed by:</td><td ></td></tr>
				  </tfoot>	
