...
if (isset($_POST['savegrades'])){
	...
	if ($_POST['finalave']>=40 AND $_POST['finalave']<=100){
		$remarks = "Passed";
	}else{
		$remarks= "Failed";
	}
			            ...
			            ?>
			              ...
			              <div class="col-md-8">
			                 <input class="form-control input-sm" id="studname" name="studname" readonly placeholder=
												  "Subject Description" type="text" value="<?php echo (isset($cur)) ? $cur->FNAME.' '.$cur->MNAME.' '.$cur->LNAME: 'Name' ;?>">
			              </div>
			            </div>
				          </div>								
...
<script type="text/javascript" language="javascript">
 ...
 function calculate(){		 
    ...
    var totalVal = parseInt(prelims) + parseInt(midterms) + parseInt(finals) ;
     ...
     document.getElementById('finalave').value = Math.round((parseInt(totalVal)/1));  
        }
</script>