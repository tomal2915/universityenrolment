		...
		<div class="form-group">
            <div class="rows">
            	...
            	<div class="col-md-4">
                	...
                	<div class="col-md-8">
                  		<input class="form-control input-sm" id="mName" name="mName" type="text" placeholder="Middle Name">
                	</div>
            	</div>

              	<div class="col-md-4">
                	<label class="col-md-4 control-label" for="bday">Birth Date</label>
					<div class="col-md-8">
              	...
              	<div class="col-md-4">
                	...
                	<div class="col-md-8">
                  		<input class="form-control input-sm" id="bplace" name="bplace" type="text" placeholder="Birth Place">
                	</div>
              	</div>
            ...
            <div class="rows">
            	...
            	<div class="col-md-4">
              	...
              	<div class="col-md-4">
                	...
                	<div class="col-md-8">
                  		<input class="form-control input-sm" id="nationality" name="nationality" type="text" placeholder="Nationality">
                	</div>
              	</div>
		...
		<div class="form-group">
            <div class="rows">
            	...
            	<div class="col-md-4">
                	...
                	<div class="col-md-8">
	                 	<input class="form-control input-sm" id="religion" name="religion" type="text" placeholder="Religion">
                	</div>
              	</div>
              	...
              	<div class="col-md-4">
               	...
               	<div class="col-md-4">
                	...
                	<div class="col-md-8">
                  		<input class="form-control input-sm" id="email" name="email" type="email" placeholder="Email address">
                	</div>
              	</div>
        ...
        <div class="form-group">
            <div class="rows">
              	...
              	<div class="col-md-8">
                	...
                	<div class="col-md-10">
                  		<input class="form-control input-sm" id="home" name="home" type="text" placeholder="Home Address">
                	</div>
              	</div>
			...
			<div class="form-group">
		        <div class="rows">
		            ...
		            <div class="col-md-6">
		                ...
		                <div class="col-md-8">
			                 <input class="form-control input-sm" id="father" name="father" type="text" placeholder="Father">
		                </div>
		            </div>
		              ...
		              <div class="col-md-6">
		                ...
		                <div class="col-md-8">
			                 <div class="checkbox">
							  ...
							  <div class="checkbox">
							    <label>
							      <input type="checkbox" name="baptismal" value="yes"/>SSC Cirtificate
							    </label>
							  ...
							  <div class="checkbox">
							    <label>
							      <input type="checkbox" name="entrance" value="yes"/>SSC Markshit
							    </label>
							    
							  </div>
							   <div class="checkbox">
							    <label>
							      <input type="checkbox" name="mir_contract" value="yes"/>HSC Cirtificate
							    </label>
							    
							  </div>
							   <div class="checkbox">
							    <label>
							      <input type="checkbox" name="certifcateOfTransfer" value="yes"/>HSC Markshit
							    </label>
