				            ...
				            <div class="col-md-8">
				              ...
				              <div class="col-md-6">
				                <input class="form-control input-sm" readonly placeholder=
									  "ID Number" type="text" value="<?php echo (isset($cur)) ? $cur->FNAME.' '.$cur->MNAME : 'Fullname' ;?>">
								</div>	  
				            ...
				            <div class="col-md-8">
				              ...
				              <div class="col-md-6">
				                <select class="form-control input-sm" name="ay" id="ay">
									...
									<option value="2014-2015">2018-2019</option>
				            ...
				            <div class="col-md-8">
				              ...
				              <div class="col-md-6">
				                 <select class="form-control input-sm" name="Semester" id="Semester">
									<option value="First">Winter</option>
				               ...
				               <label class="col-md-4 control-label"></label>
				                ...
				                <div class="col-md-8">
							         <div class="btn-group">
									    ...
									    <!-- <a href="Student_advicesubject.php" name="add" class="btn btn-default"> <span class="glyphicon glyphicon-plus"></span> Advising of Subject</a> -->
