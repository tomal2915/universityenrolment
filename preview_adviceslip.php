					...
					<div class="panel panel-primary">
					  ...
					  <div class="panel-body">
					    ...
					    <table>
				         	<thead>
							  	<tr id="table">
							  		<th width="15%" align="left">ID Number</th>
							  		<th width="15%" align="left">Name</th>
							  		<th width="15%" align="left">Status</th>
							 		<th width="15%" align="left">Academic Year</th>
							 		<th width="15%" align="left">Semester</th>
				  ...
				  <tfoot>
					...
					$mydb->setQuery("SELECT SUM(UNIT) as UN
				  	...
				  	<tr><td colspan="2">Date Printed:  <? print(Date("l F d, Y")); ?></td>
				  		<td  colspan="4" align="Right"><Strong>Total: </Strong></td><td align="center" ><strong><?php echo $result->UN;?></strong></td>
				  	</tr>
				  	<tr><td  colspan="7"></td></tr>
				  	...
				  	<tr><td  colspan="2">Date Printed: <? print(Date("1 F d, Y"));?></td>
